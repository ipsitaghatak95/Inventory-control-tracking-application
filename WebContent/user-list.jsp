        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="user" items="${listUser}">
                <tr>
                    ...
                    <td>
                    	<a href="edit?productid=<c:out value='${user.productid}' />" class="w3-medium w3-button w3-hover-black">Update</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="delete?productid=<c:out value='${user.productid}' />" class="w3-medium w3-button w3-hover-black">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
